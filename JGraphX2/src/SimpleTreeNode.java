...
public class SimpleTreeNode<T>{
    ...
    public static void main(String[] args) {
        SimpleTreeNode<String> root = new SimpleTreeNode<>("Animism");
        root.addChild("Nostratic");


        SimpleTreeNode<String> child1 = new SimpleTreeNode<>("Proto-Indo European ");
        child1.addChild("Greek");
        child1.addChild("Greco-Roman");

        SimpleTreeNode<String> child2 = new SimpleTreeNode<>("Paleo-Indian ");

        child2.addChild("Archaic Indian ");

        root.addChild(child1);
        root.addChild(child2);
        SimpleTreeNode<String> child3 = new SimpleTreeNode<>("Nilotic ");

        child3.addChild(new SimpleTreeNode<>("Ethiopian"));
        root.addChild(child3);

        root.addChildren(Arrays.asList(
                new SimpleTreeNode<>("Arabian"),
                new SimpleTreeNode<>("Iranian"),
                new SimpleTreeNode<>("Asian")
        ));
